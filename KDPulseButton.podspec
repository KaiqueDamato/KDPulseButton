Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/KaiqueDamato/KDPulseButton.git"
  s.license      = "MIT"
  s.author       = { 'Kaique Pantosi Damato' => 'kaiquedamato@icloud.com' }
  s.social_media_url   = "https://twitter.com/KaiqueDamato"
  s.platform     = :ios, "8.0"
  s.source       = { :git => "https://github.com/KaiqueDamato/KDPulseButton.git", :tag => "1.0.1" }
  s.source_files  = "KDPulseButton", "KDPulseButton/**/*.{h,m,swift}"
